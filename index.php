				  ...
				  <div class="card-body">
					...
					<div class="tab-content">
						<div id="itemDetailsTab" class="container-fluid tab-pane active">
							...
							<form action="model/item/insertItem.php" method="post">
							  <div class="form-row">
							  ...
							  <div class="form-row">
								...
								<div class="form-group col-md-3">
								  ...
								  <input type="text" class="form-control" name="itemDetailsTotalStock" id="itemDetailsTotalStock" readonly title="this will added to previous item">
								</div>
								<div class="form-group col-md-3">
								...
								<div class="form-row">
								<div class="form-group col-md-6">
								  <label for="vendorDetailsVendorFullName">Vendor Full Name<span class="requiredIcon">*</span></label>
							  ...
							  <button type="button" id="addItem" name="addItem" class="btn btn-success">Add Item</button>
